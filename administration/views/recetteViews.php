...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Nouvelle recette</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Ajouter une nouvelle recette</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 col-lg-8 col-xl-8 col-xs-12 col-sm-12 form-width">
                            <form action="../../controller/controllerPost.php" method="post" enctype="multipart/form-data" novalidate>
                                <div class="form-group">
                                    <label for="title"> Photo de la recette </label>
                                ...
                                <div class="form-group">
                                    <label for="content"> Listez les ingrédients </label>
                                ...
                                <div class="row">
                                    <div class=" col form-group">
                                        ...
                                        <input type="number" class="form-control" name="description_post" id="description" placeholder="Desciption" data-toggle="tooltip" data-placement="top" title="Ajouter une breve description de l'article" required/>
                                    </div>
                                    <div class=" col form-group">
                                        <label for="description"> Pour (nombre de personnes) </label>
                                        <input type="number" class="form-control" name="description_post" id="description" placeholder="Desciption" data-toggle="tooltip" data-placement="top" title="Ajouter une breve description de l'article" required/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="title"> Description de la recette </label>
                                    <input type="text" class="form-control" name="titre_post" id="title" placeholder="Titre" required />
                                </div>
